...
subfolder <- "appendix/sim_output/2026-04-29/20species/"
...
# Fig 2
heat_alpha_gamma_combined <- heat_alpha + labs(subtitle = "20 species in regional species pool") + 
  heat_gamma + labs(subtitle = "20 species in regional species pool")+
  plot_layout(ncol = 1) +
  plot_annotation(tag_levels = "A")
ggsave(paste0("appendix/figures/Fig2_20sp.pdf"), plot = heat_alpha_gamma_combined, width = 8, height = 8)
ggsave(paste0("appendix/figures/Fig2_20sp.png"), plot = heat_alpha_gamma_combined, width = 8, height = 8, dpi = 500, bg = "white")

# Fig 3
heat_beta_combined <- heat_beta_spatial + labs(subtitle = "20 species in regional species pool") + 
  heat_beta_temporal + labs(subtitle = "20 species in regional species pool") + 
  plot_layout(ncol = 1)  +
  plot_annotation(tag_levels = "A")
ggsave(paste0("appendix/figures/Fig3_20sp.pdf"), plot = heat_beta_combined, width = 8, height = 8)
ggsave(paste0("appendix/figures/Fig3_20sp.png"), plot = heat_beta_combined, width = 8, height = 8, dpi = 500, bg = "white")
...
fig_env_costs <- patches_over_time |> 
  ...
  labs(x = "Emigration rate", subtitle = "20 species in regional species pool",
...
fig_env_bio_filter <- 
  ...
  plot_annotation(tag_levels = "A")
ggsave(filename = paste0("appendix/figures/Fig4_20sp.png"),
       plot = fig_env_bio_filter, width = 7, height = 7, dpi = 500, bg = "white")
ggsave(filename = paste0("appendix/figures/Fig4_20sp.pdf"),
...
fig_demog <- fig_demo_extinctions + fig_dispersal_fitness_effects +
  ...
  plot_annotation(tag_levels = "A")
ggsave(filename = paste0("appendix/figures/Fig5_20sp.png"),
       plot = fig_demog, width = 8, height = 6, dpi = 500, bg = "white")
ggsave(filename = paste0("appendix/figures/Fig5_20sp.pdf"),
...
############# 75 species ##############
subfolder <- "appendix/sim_output/2026-04-29/75species/"
comp_scenario <- "stable"
...
# Fig 2
heat_alpha_gamma_combined <- heat_alpha + labs(subtitle = "75 species in regional species pool") + 
  heat_gamma + labs(subtitle = "75 species in regional species pool")+
  plot_layout(ncol = 1) +
  plot_annotation(tag_levels = "A")
ggsave(paste0("appendix/figures/Fig2_75sp.pdf"), plot = heat_alpha_gamma_combined, width = 8, height = 8)
ggsave(paste0("appendix/figures/Fig2_75sp.png"), plot = heat_alpha_gamma_combined, width = 8, height = 8, dpi = 500, bg = "white")

# Fig 3
heat_beta_combined <- heat_beta_spatial + labs(subtitle = "75 species in regional species pool") + 
  heat_beta_temporal + labs(subtitle = "75 species in regional species pool") + 
  plot_layout(ncol = 1)  +
  plot_annotation(tag_levels = "A")
ggsave(paste0("appendix/figures/Fig3_75sp.pdf"), plot = heat_beta_combined, width = 8, height = 8)
ggsave(paste0("appendix/figures/Fig3_75sp.png"), plot = heat_beta_combined, width = 8, height = 8, dpi = 500, bg = "white")
...
fig_env_costs <- patches_over_time |> 
  ...
  scale_color_viridis_d(option = "B", end = .9) +
  facet_grid(. ~ spat_heterogeneity) +
  labs(x = "Emigration rate", subtitle = "75 species in regional species pool",
       y = "Mean fitness effects \n of env. filtering",
       color = "Dispersal kernel\n exponent")
...
fig_env_bio_filter <- 
  ...
  plot_layout(nrow = 3, guides = "collect") +
  plot_annotation(tag_levels = "A")
ggsave(filename = paste0("appendix/figures/Fig4_75sp.png"),
       plot = fig_env_bio_filter, width = 7, height = 7, dpi = 500, bg = "white")
ggsave(filename = paste0("appendix/figures/Fig4_75sp.pdf"),
       plot = fig_env_bio_filter, width = 7, height = 7, dpi = 500)
...
fig_demog <- fig_demo_extinctions + fig_dispersal_fitness_effects +
  plot_layout(nrow = 2, guides = "collect") +
  plot_annotation(tag_levels = "A")
ggsave(filename = paste0("appendix/figures/Fig5_75sp.png"),
       plot = fig_demog, width = 8, height = 6, dpi = 500, bg = "white")
ggsave(filename = paste0("appendix/figures/Fig5_75sp.pdf"),
       plot = fig_demog, width = 8, height = 6)
